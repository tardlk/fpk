...
distributor_url = https://github.com/tardlk/fpk
desktop_uidir   = ui
...
${CHANGELOG}
**国内镜像**:
- [${FILE_PREFIX}_${VERSION}_x86.fpk](https://ghfast.top/https://github.com/tardlk/fpk/releases/download/${RELEASE_TAG}/${FILE_PREFIX}_${VERSION}_x86.fpk)
- [${FILE_PREFIX}_${VERSION}_arm.fpk](https://ghfast.top/https://github.com/tardlk/fpk/releases/download/${RELEASE_TAG}/${FILE_PREFIX}_${VERSION}_arm.fpk)
EOF
